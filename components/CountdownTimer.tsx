    ...
    >
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
        <motion.h2 
          ...
          className='font-marianna text-5xl  md:text-7xl text-accent-dark mb-4'
        >
        ...
        >
          {timeUnits.map((unit) => (
            ...
            >
              <div className='font-cormorant-sc text-3xl md:text-4xl lg:text-5xl text-accent-dark mb-2'>
                {unit.value.toString().padStart(2, '0')}
              </div>
              <div className='font-cormorant-sc text-primary-500 uppercase text-xs md:text-lg tracking-wider'>
                {unit.label}
              </div>
            </div>
          ))}
